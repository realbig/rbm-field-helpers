        ...
        value: function repeaterHide($item, deleteItem) {
            ...
            if (confirm(this.options.l10n['confirm_delete_text'])) {
                ...
                $item.slideUp(400, function () {
                    ...
                    deleteItem();
                    _this2.$field.trigger('repeater-delete-item', [$item]);
                });
            }
        }
    }]);
    ...
    function FieldRepeaterInitialize($root) {
        ...
        if ($fields.length) {
            ...
            if (!jQuery.isFunction(jQuery.fn.sortable)) {
                ...
                console.error('Field Helpers Error: Trying to initialize Repeater field but "rbm-fh-jquery-repeater" ' + 'is not enqueued.');
                return;
            }
...
var FieldSelect = function (_Field) {
    ...
    _createClass(FieldSelect, [{
        ...
        value: function fieldCleanup() {
            ...
            this.$field.removeClass('select2-hidden-accessible').removeAttr('tablindex aria-hidden').find('option:selected').prop('selected', false);
        }
    }]);
    ...
    _createClass(FieldTextArea, [{
        ...
        value: function initField() {
            ...
            if (this.options.wysiwyg) {
                ...
                var settings = jQuery.extend(wp.editor.getDefaultSettings(), this.options.wysiwygOptions);
