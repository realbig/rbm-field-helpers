(function ($) {
    ...
    $(function () {
        ...
        var $lists = $('.fieldhelpers-field-list'),
            $repeaters = $('.fieldhelpers-field-repeater');
        ...
        function list_repeater_add(e, $item) {
            ...
            var $lists = $item.find('.fieldhelpers-field-list');
        ...
        function lists_init($lists) {
            ...
            $lists.each(function () {
                ...
                $(this).find('ul[data-fieldhelpers-list]').sortable(sortable_args);
            });
        }
    });
})(jQuery);