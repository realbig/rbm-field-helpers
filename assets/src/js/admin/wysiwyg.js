(function ($) {
    ...
    $(function () {
        ...
        var $repeaters = $('.fieldhelpers-field-repeater');
    ...
    function replace_wysiwygs($wysiwygs) {
        ...
        var name = $( $wysiwygs[0] ).closest( '.fieldhelpers-field-repeater-list' ).data( 'repeater-list' );
    ...
    function repeater_change(e, $repeaterRow ) {
        ...
        var $wysiwygs = $repeaterRow.parent().find('.fieldhelpers-field-wysiwyg');
